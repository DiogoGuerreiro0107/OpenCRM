...
Utilizador inicial criado pelo seed: `admin@globaltoner.local` / `admin123` (papel `ADMINISTRADOR`). Corre `pnpm --filter backend prisma:seed` depois do primeiro `pnpm dev` para o criar.
